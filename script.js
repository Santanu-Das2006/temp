...
text.innerHTML = '<span>I</span><span>m</span><span>p</span><span>r</span><span>o</span><span>v</span><span>e</span><span><br></span><span>y</span><span>o</span><span>u</span><span>r</span><span> </span><span>m</span><span>i</span><span>n</span><span>d</span>'
...
anime({
    ...
    delay: anime.stagger(100, { start: 800 }), // Delay the start of the animation
    easing: 'easeInOutQuad'
});
